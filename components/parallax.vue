  ...
  <div class="parallax-container">
    <div class="parallax">
      ...
      <!-- <div id="slide2" class="slide">
        <div class="title">
          <p>many of our brave comrades have fallen while fighting the menace</p>
        </div>
      </div>
...
export default {
  ...
  methods: {
    getStuff() {
      ...
      request.open('GET', 'https://nblog-strapi.herokuapp.com/kafes', true);
      var that = this;
      request.onload = function () {
        ...
        var data = JSON.parse(this.response);
          ...
          data.forEach(item => {
            if (item.id == 1) {
              that.headline = item.name;
              that.desc = item.description;
            }
          });
      }
...
#title {
  background-image: url("http://nadiaschnack.com/panny/wp-content/uploads/2015/05/background1.jpg");
  z-index:2;
}
#title h1 {
